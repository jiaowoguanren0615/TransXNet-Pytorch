...
@register_model
def transxnet_t(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def transxnet_s(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def transxnet_b(pretrained=False, pretrained_cfg=None,
